					...
					<div class="chat" id="chat1">
						<div class="top">
							<div class="container">
								<div class="col-md-12">
									<div class="inside">
										<a href="#"><img class="avatar-md" src="https://stafforgserv.com.au/wp-content/uploads/2018/09/user-img.png" data-toggle="tooltip" data-placement="top" title="Keith" alt="avatar"></a>
										<div class="status">											
											<span class="material-icons online"><i class="fas fa-record-vinyl" aria-hidden="true"></i></span>	
										</div>
										<div class="data">
											<h5><a href="#">Martelin Ouro</a></h5>
											<span>Ativo agora</span>
										</div>											
										<button class="btn connect d-md-block d-none" name="1"><span class="material-icons md-30"><i class="fas fa-search" aria-hidden="true"></i></span></button>
										<div class="dropdown">
											<button class="btn" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="material-icons md-30"><i class="fas fa-ellipsis-v" aria-hidden="true"></i></span></button>
											<div class="dropdown-menu dropdown-menu-right">
												<button class="dropdown-item"><i class="fa fa-database" aria-hidden="true"></i> Dados do contato</button>
												<hr>											
												<button class="dropdown-item"><i class="fas fa-ban" aria-hidden="true"></i> Block Contact</button>
												<button class="dropdown-item"><i class="fas fa-user-minus"></i> Delete Contact</button>
											</div>
										</div>
									</div>
								</div>
						...
						<div class="content" id="content">
							<div class="container">
								<div class="col-md-12">
									...
									<div class="message">
										<img class="avatar-md" src="https://stafforgserv.com.au/wp-content/uploads/2018/09/user-img.png" data-toggle="tooltip" data-placement="top" title="Keith" alt="avatar">
										<div class="text-main">
											<div class="text-group">
												<div class="text">
													<p>Já temos algumas ideias matadoras sobre.</p>
												</div>
											</div>
											<span>09:46 AM</span>
										</div>
									...
									<div class="message me">
										<div class="text-main">
											<div class="text-group me">
												<div class="text me">
													<p>Mal posso esperar! Como estamos nos saindo com o cliente??</p>
												</div>
											</div>
											<span>11:32 AM</span>
										</div>
									...
									<div class="message">
										...
										<div class="text-main">
											<div class="text-group">
												<div class="text">
													<p>Está indo muito bem, temos um rascunho para as pedreiras do cliente concluído.</p>
												</div>
											</div>
											<span>02:56 PM</span>
										</div>
									...
									<div class="message me">
										<div class="text-main">
											<div class="text-group me">
												<div class="text me">
													<p>Roger aquele chefe!</p>
												</div>
											</div>
											<div class="text-group me">
												<div class="text me">
													<p>Já comecei a reunir algumas coisas para os painéis de humor, estou ansioso para começar!</p>
												</div>
											</div>
											<span>10:21 PM</span>
										</div>
									...
									<div class="message">
										...
										<div class="text-main">
											<div class="text-group">
												<div class="text">
													<p>Bom começo pessoal, adicionei algumas notas à tarefa. Podemos precisar fazer alguns ajustes nos últimos itens - mas nada demais!</p>
												</div>
											</div>
											<span>11:07 PM</span>
										</div>
									...
									<div class="message me">
										<div class="text-main">
											<div class="text-group me">
												<div class="text me">
													<p>Vejo vocês às 2 para uma reunião inicial.</p>
												</div>
											</div>
											<span>10:21 PM</span>
										</div>
											...
											<div class="text-group">
												<div class="text">
													<div class="attachment">
														<button class="btn attach"><span class="material-icons md-18"><i class="fa fa-file" aria-hidden="true"></i></span></button>
														<div class="file">
															<h5><a href="#">teste.pdf</a></h5>
															<span>Documento 24kb</span>
														</div>
													</div>
												</div>
											</div>
									...
									<div class="message me">
										<div class="text-main">
											<div class="text-group me">
												<div class="text me">
													<p>Espero que todos estejam prontos para enfrentar este grande projeto. Vamos destruir alguns conceitos e design de marca!!</p>
												</div>
											</div>
											<span><i class="material-icons">Visto</i>10:21 PM</span>
										</div>
									</div>
									<div class="message">
										<img class="avatar-md" src="https://stafforgserv.com.au/wp-content/uploads/2018/09/user-img.png" data-toggle="tooltip" data-placement="top" title="Keith" alt="avatar">
							...
							<div class="col-md-12">
								<div class="bottom">
									<form class="position-relative w-100">
										<textarea class="form-control" placeholder="Comece a digitar para responder ..." rows="1"></textarea>
										<button class="btn emoticons"><span class="material-icons"><i class="far fa-smile"></i></span></button>
										<button type="submit" class="btn send"><span class="material-icons"><i class="fa fa-paper-plane" aria-hidden="true"></i></span></button>
									</form>
									<label>
										<input type="file">
										<span class="btn attach d-sm-block d-none"><span class="material-icons"><i class="fas fa-paperclip"></i></span></span>
									</label> 
								</div>
							</div>
						</div>
